...
PRED_PATH=$(readlink -f $HOME/Work/my_projects/block_experiments/production/inference)
...
nvidia-docker run --rm \
    ...
    /bin/bash -c "export CUDA_VISIBLE_DEVICES=$3; PYTHONPATH=${GUNPOWDER_PATH}:${SIMPLEFERENCE_PATH}:${Z_PATH}:\$PYTHONPATH; python -u ${PRED_PATH}/run_inference.py $1 $2 $3 $4"
