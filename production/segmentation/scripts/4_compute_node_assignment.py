...
def compute_node_assignment(cache_folder, n_jobs):

    assignments = []
    for job_id in range(n_jobs):
        res_path = os.path.join(cache_folder, 'node_assignments_job%i.npy' % job_id)
...
if __name__ == '__main__':
    ...
    compute_node_assignment(args.cache_folder, args.n_jobs)
